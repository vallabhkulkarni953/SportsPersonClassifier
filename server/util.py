...
# TO send image to backend, we will convert the image to bit64 string 

def classify_image(image_base64_data,filepath=None):
    imgs = get_cropped_image_if_2_eyes(filepath,image_base64_data)
...
if __name__ == "__main__":
    ...
    # print(classify_image(get_base64_test_image_for_maria(),filepath=None))
    # print(class_number_to_name(1))
    print(classify_image(None,"./server/test images/maria1.jpg"))
    print(classify_image(None,"./server/test images/maria2.jpg"))
    print(classify_image(None,"./server/test images/roger1.jpg"))
    print(classify_image(None,"./server/test images/roger2.jpg"))
